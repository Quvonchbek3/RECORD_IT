    ...
    <div className="bg-[rgb(237,248,255)] dark:bg-[#2f607f]">
      ...
      <div className="flex justify-center pr-[80px] pt-[4%]">
        <div className="w-[40%]" data-aos="fade-right">
          <h1 className="text-blue-600 dark:text-gray-200 font-[700] text-[100%] sm:text-[200%] md:text-[300%]">
            Xalqaro&nbsp;darajadagi&nbsp;IT<br /> companiyaga <br /> xush kelibsizlar
          </h1>
          <p className="text-gray-500 dark:text-gray-400 font-[400] text-[65%] sm:text-[100%]">Sizni ko’rib turganimizdan <br /> juda ham xursandmiz!</p>
        </div>
